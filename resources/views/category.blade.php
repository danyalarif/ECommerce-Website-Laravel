		...
		<div class="container">
			<div class="row">
				<div class="countdown-container">
					...
					<span class="countdown-heading" id="category-title">{{$category}}</span>
				</div>
			...
			<div class="button-container" style="text-align: center;margin-top: 1rem;">
				<button id="loadMore" class="custom-button-rounded custom-button-secondary">Load More</button>
				<p id="moreproductserror" style="color: var(--backgroundSecondary);margin-top: 1rem;"></p>
			</div>
		</div>
	</div>
	<!-------FOOTER------------>
