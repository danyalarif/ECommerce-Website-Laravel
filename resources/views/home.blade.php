...
<body>
	...
	<!--------BODY------------>
	<div class="body">
		<div class="container highest-rated-products-container sale-products-container">
			<div class="row">
				<div class="countdown-container">
					<span class="countdown-border"></span>
					<span class="countdown-heading">On Sale</span>
					<span class="countdown">24:00:00</span>
				</div>
				<div style="width: 100%;" class="dropdown-divider"></div>
			</div>
			<div class="row product-row" style="margin-top: 1rem;">
				@foreach($saleProducts as $product)
				<div class="product-container col-12 col-sm-6 col-md-3 col-lg-2 col-xl-2" id="{{$product->idProducts}}">
					<div class="product">
						...
						<div class="product-body">
							...
							<div class="product-price-container">
								<span class="product-original-price-container-span" style="margin-right: 0.5rem;text-decoration: line-through;color: var(--textColor);">
									<span class="product-original-price-label">Rs.</span>
									<span class="product-original-price">{{$product->producingCost + ($product->producingCost * ($product->profit / 100))}}</span>
								</span>
								<span class="product-price-label">Rs.</span>
								<span class="product-price">{{($product->producingCost + ($product->producingCost * ($product->profit / 100))) - ($product->producingCost * ($product->salePercentage / 100))}}</span>
							</div>
		...
		<div class="container rated-products-container">
			<div class="row">
				<div class="countdown-container">
					<span class="countdown-border"></span>
					<span class="countdown-heading">Highest Rated Products</span>
				</div>
				<div style="width: 100%;" class="dropdown-divider"></div>
			</div>
			<div class="row product-row" style="margin-top: 1rem;">
				@foreach($highestRateProducts as $product)
		...
		<div class="container new-products-container">
			<div class="row">
				<div class="countdown-container">
					<span class="countdown-border"></span>
					<span class="countdown-heading">New Products</span>
				</div>
				<div style="width: 100%;" class="dropdown-divider"></div>
			</div>
			<div class="row product-row" style="margin-top: 1rem;">
